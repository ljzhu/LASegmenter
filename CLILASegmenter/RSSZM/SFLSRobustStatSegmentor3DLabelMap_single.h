...
public:
  ...
  typedef std::vector<ComplexT>                  ComplexT1D;
  ...
  void computeForce();
  void ComputeRSSForce();
  void ComputeRSSZMForce();
...
private:
  void LoadZMReference();
  void LoadRadVolPrior();
  void ComputeZM();
  void EvaluateERSS();
  void EvaluateRSSCof();
  ...
  int m_zmInter;
  double m_rssWeight;
  double m_devRssWeight;
  unsigned long m_numIterRSS;
  std::string m_fnInter;

   std::string m_fnRadVolPrior;
   double m_LAVolMean;
   double m_LAVolSTD;
   double m_LARMean;
   double m_LARSTD;
   double m_laSeedRad;
   double m_RSSZMFactor;
   double m_RSSZMShiftFactor;
   double m_EZMVal;
   double m_ERSSVal;
   double m_DERSSZMVal;
